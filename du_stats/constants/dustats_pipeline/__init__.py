...
DUSTATS_TRANSFORMATION_CONVNET_SEQ_LEN:int=960
...
DUSTATS_NN_MODEL_FILENAME:str='model.pth'
DUSTATS_NN_NUM_HIDDEN_LAYERS:int=2
DUSTATS_NN_NUM_NEURONS:int=128
DUSTATS_NN_NUM_TRAINING_EPOCHS:int=100
